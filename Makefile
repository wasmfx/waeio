...
WASIFLAGS=--std=c17 -Wall -I include -O3
CC=clang-17
...
echoserver_wasi: examples/echoserver.c
	$(WASICC) src/fiber_asyncify.c src/waio_wasi.c $(WASIFLAGS) examples/echoserver.c -o echoserver_wasi.wasm
